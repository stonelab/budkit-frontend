<?xml version="1.0"?>
<tpl:layout xmlns:tpl="http://budkit.org/tpl" name="post-figure">
        ...
        <div class="item has-featured-img">
            <div class="stream-content">
                <h3 class="subject heading">
                    ...
                    <tpl:link rel="person" name="Livingstone Fultang" status="offline"
                ...
                <div class="body clearfix">
                    <p>
                        Good result for <a href="">@Hugh_Small</a> and <a
                ...
                <div class="stream-media">
                    <figure>
                        ...
                        <figcaption>
                            <h4>Exhibit B. The <cite>Rough Copy</cite> trailer.</h4>
