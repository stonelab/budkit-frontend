...
<tpl:layout  xmlns:tpl="http://budkit.org/tpl" name="widgets">
    <div class="col-md-12 ptm">

        <div class="panel panel-statistic">
            <div class="panel-heading">
                <h4 class="panel-title color-turquoise">How we are performing</h4>
                ...
                <div class="row">
                    <div class="col-xs-6 col-md-3">
                        ...
                        <div class="pull-left">
                            ...
                            <h3>2.3k</h3>
                            <h5 class="color-turquoise">2.00% increased</h5>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <div class="pull-left">
                        ...
                        <h3>38.10</h3>
                        <h5 class="color-danger">5.70% decreased</h5>
                    </div>
                    <div class="col-xs-6 col-md-3">
                        <div class="pull-left">
                            <div class="icon icon icon-information"><i class="fa fa-info"></i></div>
                    ...
                    <div class="col-xs-6 col-md-3">
                        ...
                        <h3>10</h3>
                        <h5 class="color-turquoise">5.00% increased</h5>
                    </div>
                </div><!-- row -->
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                <h4 class="panel-title color-turquoise">Products Added</h4>
                                <h3>75.7%</h3>
                                <div class="progress">
            ...
            <div class="col-sm-6 prn">
                <div class="panel panel-success-full panel-updates">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                <h4 class="panel-title color-turquoise">Products Sold</h4>
                                <h3>55.4%</h3>
                                <div class="progress">
            ...
            <div class="col-sm-6">
                <div class="panel panel-updates">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-7 col-lg-8">
                                <h4 class="panel-title color-danger">Products Returned</h4>
                                <h3>22.1%</h3>
                                <div class="progress">
